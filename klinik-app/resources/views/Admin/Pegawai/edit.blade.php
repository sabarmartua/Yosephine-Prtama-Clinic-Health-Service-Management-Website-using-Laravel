...
<head>
    ...
    <title>Edit Pegawai - Klinik Yosephine</title>
            ...
            <div class="content">
                <form action="{{ route('pegawai.update', $pegawai->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="profesi" name="profesi" value="{{ $pegawai->profesi }}" required>
                    </div>
                    <div class="form-group">
                        <label for="gambar">Gambar</label>
                        <input type="file" class="form-control-file" id="gambar" name="gambar">
                        @if($pegawai->gambar)
                            <img src="{{ asset('storage/' . $pegawai->gambar) }}" width="100" alt="{{ $pegawai->nama }}">
                        @endif
                    </div>
                    <div class="form-group">
                        <label for="nomor_telepon">Nomor Telepon</label>
                        <input type="text" class="form-control" id="nomor_telepon" name="nomor_telepon" value="{{ $pegawai->nomor_telepon }}" required>
                    </div>
                    <div class="form-group">
