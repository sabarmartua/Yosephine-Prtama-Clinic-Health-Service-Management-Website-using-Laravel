                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('faq.store') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="pertanyaan" name="pertanyaan" placeholder="Tulis pertanyaan kategori di sini..">
                                    </div>
                                    <div class="form-group">
                                        <label for="jawaban">Jawaban:</label>
                                        <input type="text" class="form-control" id="jawaban" name="jawaban" placeholder="Tulis jawaban kategori di sini..">
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="card">
                                            <div class="card-body">
                                                <h5 class="card-title"><i>Pertanyaan :</i></h5>
                                                <h5 >{{ $faq->pertanyaan }}</h5>
                                                <h5 class="card-title"><i>Jawaban :</i></h5>
                                                <h5>{{ $faq->jawaban }}</h5>
                                                <form action="{{ route('faq.destroy', $faq->id) }}" method="POST" class="delete-form">
                                                    @csrf
                                                    @method('DELETE')
