...
<head>
    ...
    <title>Edit Obat - Klinik Yosephine</title>
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('obat.update', $obat->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="jumlah_stok" name="jumlah_stok" value="{{ $obat->jumlah_stok }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="deskripsi">Deskripsi:</label>
                                        <textarea class="form-control" id="deskripsi" name="deskripsi">{{ $obat->deskripsi }}</textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="harga">Harga</label>
                                        <input type="number" class="form-control" id="harga" name="harga" step="0.01" value="{{ $obat->harga }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="tanggal_expired">Tanggal Expired:</label>
                                        <input type="date" class="form-control" id="tanggal_expired" name="tanggal_expired" value="{{ $obat->tanggal_expired }}">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        @if ($obat->gambar)
                                        <div class="mt-2">
                                            <img src="{{ asset('storage/' . $obat->gambar) }}" alt="Gambar Obat" width="100">
                                        </div>
                                        @endif
                                    </div>
