...
<head>
    ...
    <title>Detail Fasilitas - Klinik Yosephine</title>
            ...
            <div class="content">
                <div class="card">
                    <div class="card-body">
                        ...
                        <img src="{{ asset('storage/' . $facility->image_path) }}" alt="{{ $facility->image_path }}" class="img-fluid" style="width: 500px; height: 400px;">
                        @endif
                        <br><br><p class="card-text">{{ $facility->description }}</p>
                        <a href="{{ route('facilities.index')}}" class="btn btn-info btn-sm">Kembali</a>
                    </div>
                </div>
            </div>
        </div>
