                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('artikel.update', $artikel->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="kategori_artikel_id" name="kategori_artikel_id">
                                            @foreach($kategoriArtikels as $kategori)
                                            <option value="{{ $kategori->id }}" {{ $kategori->id == $artikel->kategori_artikel_id ? 'selected' : '' }}>{{ $kategori->nama }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="isi" name="isi">{{ $artikel->isi }}</textarea>
                                    </div>
