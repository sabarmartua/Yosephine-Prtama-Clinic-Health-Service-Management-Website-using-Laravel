...
<head>
    ...
    <title>Manajemen Layanan - Klinik Yosephine</title>
...
<body>
    ...
    <div class="header">
        ...
        <div class="page-wrapper">
            <div class="content">
                <div class="header-title">Manajemen Layanan</div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between mt-3">
                                    <a href="{{ route('services.show', $service->id) }}" class="btn btn-success btn-sm">Lihat Detail</a>
