                ...
                <form action="{{ route('jadwals.update', $jadwal->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="pegawai_id" name="pegawai_id" required>
                            ...
                            <option value="{{ $pegawai->id }}" {{ $jadwal->pegawai_id == $pegawai->id ? 'selected' : '' }}>{{ $pegawai->nama }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div id="jadwal-container">
                        @foreach($jadwal->jadwal as $index => $item)
                        <div class="jadwal-item">
                            <hr>
                            <div class="form-group">
                                <label for="hari">Hari</label>
                                <input type="text" class="form-control" id="hari" name="jadwal[{{ $index }}][hari]" value="{{ $item['hari'] }}" required>
                            </div>
                            <div class="form-group">
                                <label for="jam_mulai">Jam Mulai</label>
                                <input type="time" class="form-control" id="jam_mulai" name="jadwal[{{ $index }}][jam_mulai]" value="{{ $item['jam_mulai'] }}" required>
                            </div>
                            <div class="form-group">
                                <label for="jam_selesai">Jam Selesai</label>
                                <input type="time" class="form-control" id="jam_selesai" name="jadwal[{{ $index }}][jam_selesai]" value="{{ $item['jam_selesai'] }}" required>
                            </div>
                        </div>
                        @endforeach
                    </div>
