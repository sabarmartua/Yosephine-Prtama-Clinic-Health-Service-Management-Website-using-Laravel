        ...
        <div class="container mt-5 main-content">
            ...
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <h2 class="card-text">{{ Str::limit($post->body, 100) }}</h2><br>
                    <h5 class="card-text"><strong class="text-muted">Posted by {{ $post->user->name }} on {{ $post->created_at->format('d M, Y') }}</strong></h5>
                    <a href="{{ route('posts.show', $post) }}" class="comment-btn"> {{ $post->replies_count }} Komentar</a>
                </div>
            </div>
            @endforeach
            @endif
            ...
            <div class="alert alert-warning">
                <h2>Please login to access this section.</h2>
            </div>
            @endguest
        </div>
    </main>
