...
<head>
    ...
    <title>Obat - Yosephine Pratama</title>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        ...
                        @endif
                        <div class="card-body">
                            <h2 class="card-title">{{ $obat->nama }}</h2>
                            <p class="card-text">{{ \Illuminate\Support\Str::limit($obat->deskripsi, 200) }}</p>
                            <a href="{{ route('user.obat.show', $obat->id) }}" class="btn btn-primary">View More</a>
                        </div>
                    </div>
                </div>
                @endforeach
