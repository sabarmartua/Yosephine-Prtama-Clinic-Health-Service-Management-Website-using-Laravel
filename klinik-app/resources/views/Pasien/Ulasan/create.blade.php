...
<head>
    ...
    <title>Buat Ulasan - Yosephine Pratama</title>
...
<header>
    ...
    <main>
        <div class="container mt-5">
            <h1 class="mb-4">Buat Ulasan Baru</h1>
            @if ($errors->any())
            ...
            <form action="{{ route('ulasan.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="isiUlasan" name="isiUlasan" rows="4" required>{{ old('isiUlasan') }}</textarea>
                </div>
