...
<head>
    ...
    <style>
        ...
        .facility-icon.collapsed {
            transform: rotate(0deg);
        }

        .facility-icon.expanded {
        ...
        <div class="container">
            ...
            <div class="accordion" id="facilityAccordion">
                ...
                <div class="card facility-item">
                    <div class="card-header" id="heading{{ $facility->id }}">
                        <h2 class="mb-0">
                            <a class="facility-name" data-toggle="collapse" href="#collapse{{ $facility->id }}" aria-expanded="true" aria-controls="collapse{{ $facility->id }}">
                                {{ $facility->name }}
                                <i class="facility-icon fas fa-chevron-down collapsed"></i>
                            </a>
                        </h2>
                    </div>

                    <div id="collapse{{ $facility->id }}" class="collapse" aria-labelledby="heading{{ $facility->id }}" data-parent="#facilityAccordion">
                        <div class="card-body">
                        <img src="{{ asset('storage/' . $facility->image_path) }}" alt="{{ $facility->name }}" class="img-fluid" style="width: 500px; height: 500px;">
                                <br><br><p>{{ $facility->description }}</p>
                        </div>
                    </div>
                </div>
                @endforeach
